...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header">Daftar Pengajuan Pemilik Villa</div>
        <div class="card-body">
                    ...
                    @else
                        ...
                        @foreach ($requests as $request)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('storage/' . $request->villa_image) }}"
                                        class="img-thumbnail image-cover" alt="Foto Villa" width="300">
                                </td>
                                <td>
                                ...
                                <td>{{ $request->expired_at ? \Carbon\Carbon::parse($request->expired_at)->format('d M Y H:i') : '-' }}
                                </td>
                                <td>
                                    @if ($request->status == 'pending')
