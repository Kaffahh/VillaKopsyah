                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="user_id" class="form-select @error('user_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($users as $user)
                                            <option value="{{ $user->id }}" {{ $villa->user_id == $user->id ? 'selected' : '' }}>
                                                {{ $user->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="type_id" class="form-select @error('type_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($types as $type)
                                            <option value="{{ $type->id }}" {{ $villa->type_id == $type->id ? 'selected' : '' }}>
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="price_per_night" 
                                               ...
                                               value="{{ old('price_per_night', $latestPrice->price_per_night ?? '') }}" required>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                        <option value="available" {{ $villa->status == 'available' ? 'selected' : '' }}>
                                            Tersedia
                                        </option>
                                ...
                                <div class="mb-3">
                                            ...
                                            @foreach($villa->images as $image)
                                                <div class="col-md-3 mb-2">
                                                    <div class="position-relative">
                                                        ...
                                                        <!-- Tombol Hapus -->
                                                        <form action="{{ route('admin.villa.image.delete', $image->id) }}" 
                                                              method="POST" 
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <small class="text-muted">
                                            Upload beberapa gambar sekaligus. Format: JPG, PNG, GIF (Max: 2MB per gambar)
                                        </small>
                                    </div>
                                    @error('images.*')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
